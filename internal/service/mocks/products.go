...
// Create provides a mock function with given fields: ctx, productDTO
func (_m *Products) Create(ctx context.Context, productDTO dto.CreateProductDTO) (domain.Product, error) {
	ret := _m.Called(ctx, productDTO)

	var r0 domain.Product
	if rf, ok := ret.Get(0).(func(context.Context, dto.CreateProductDTO) domain.Product); ok {
		r0 = rf(ctx, productDTO)
	} else {
		r0 = ret.Get(0).(domain.Product)
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, dto.CreateProductDTO) error); ok {
		r1 = rf(ctx, productDTO)
	} else {
		r1 = ret.Error(1)
	}
...
// Update provides a mock function with given fields: ctx, productDTO, productID
func (_m *Products) Update(ctx context.Context, productDTO dto.UpdateProductDTO, productID primitive.ObjectID) (domain.Product, error) {
	ret := _m.Called(ctx, productDTO, productID)

	var r0 domain.Product
	if rf, ok := ret.Get(0).(func(context.Context, dto.UpdateProductDTO, primitive.ObjectID) domain.Product); ok {
		r0 = rf(ctx, productDTO, productID)
	} else {
		r0 = ret.Get(0).(domain.Product)
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, dto.UpdateProductDTO, primitive.ObjectID) error); ok {
		r1 = rf(ctx, productDTO, productID)
	} else {
		r1 = ret.Error(1)
	}
